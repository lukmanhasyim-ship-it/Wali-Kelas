    ...
    <div className="space-y-8 pb-12 animate-fade-in">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 bg-white p-6 rounded-2xl border border-slate-100 shadow-sm no-print">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button
            onClick={handlePrint}
            className="flex items-center gap-2 px-5 py-2.5 bg-emerald-900 text-white rounded-xl text-sm font-black hover:bg-emerald-950 transition-all shadow-lg shadow-emerald-900/20"
          >
      ...
      <div ref={reportRef} id="printable-report" className="space-y-10">
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm space-y-4">
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 bg-emerald-800 rounded-full animate-pulse" />
